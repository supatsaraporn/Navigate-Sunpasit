...
import 'floor2_map.dart';

class Floor2RoomPage extends StatefulWidget {
  @override
  _Floor2RoomPageState createState() => _Floor2RoomPageState();
}

class _Floor2RoomPageState extends State<Floor2RoomPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: Firestore.instance.collection("floor2").snapshots(),
